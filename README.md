...
After adding campaign, contact, previous-outcome, and social/economic context features, then tuning hyperparameters, performance improved:

| Model | Best parameters | Test accuracy | Test ROC AUC |
| --- | --- | ---: | ---: |
| Logistic Regression | `C=0.1` | 0.8965 | 0.7808 |
| Decision Tree | `max_depth=5` | 0.8962 | 0.7675 |
| SVM | `C=10`, `kernel='rbf'` | 0.8948 | 0.7441 |
| KNN | `n_neighbors=25` | 0.8941 | 0.7646 |

Logistic Regression was the strongest overall model in this experiment, with the highest test accuracy and ROC AUC. The results also show that adding relevant customer and campaign context was more valuable than using the basic client-information feature set alone.
